...
class Planet:
    ...
    def __init__(self):
        if PLANETS == 1:
            ...
            self._st = State(
                ...
                float(random.randint(0, 300) / 100.0) - 1.5,
                float(random.randint(0, 300) / 100.0) - 1.5,
            )
        self._r = 1.5
    ...
    def acceleration(self, state, unused_t):
        ...
        for p in g_listOfPlanets:
            ...
            force = GRAVITYSTRENGTH * self._m * p._m / dsq if dsq > 1e-10 else 0.0
    ...
    def setMassFromRadius(self):
        ...
        self._m = DENSITY * 4.0 * math.pi * (self._r ** 3.0) / 3.0
    ...
    def setRadiusFromMass(self):
        ...
        self._r = (3.0 * self._m / (DENSITY * 4.0 * math.pi)) ** (0.3333)
            ...
            if not p._merged:  # for planets that have not been merged, draw a
                ...
                pygame.draw.circle(
                    ...
                    (
                        ...
                        int(
                            HEIGHTD2
                            + zoom * HEIGHTD2 * (p._st._y - HEIGHTD2) / HEIGHTD2
                        ),
                    ),
                    int(p._r * zoom),
                    0,
